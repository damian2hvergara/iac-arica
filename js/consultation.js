        ...
        <div style="padding: ${isMobile ? '24px' : '32px'}; border-bottom: var(--border); background: var(--gray-50);">
            ...
            <div style="max-width: 500px; margin: 0 auto; position: relative; border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow-md);">
                <div id="videoContainer">
                    <div style="background:linear-gradient(135deg,#833ab4 0%,#fd1d1d 50%,#fcb045 100%);padding:40px 24px;text-align:center;border-radius:var(--radius);">
                        <i class="fab fa-instagram" style="font-size:48px;color:white;margin-bottom:16px;display:block;"></i>
                        <h3 style="color:white;font-size:20px;font-weight:700;margin-bottom:8px;">Ver el proceso completo</h3>
                        <p style="color:rgba(255,255,255,0.85);font-size:14px;margin-bottom:24px;max-width:400px;margin-left:auto;margin-right:auto;">
                            Mira cómo importamos y entregamos tu vehículo desde USA hasta Arica. Todo el proceso real.
                        </p>
                        <a href="https://www.instagram.com/reel/C6ymBykukrm/" target="_blank"
                           onclick="trackInteraction('clicked_instagram_video',10);trackVideoLoad();"
                           style="display:inline-flex;align-items:center;gap:10px;background:white;color:#833ab4;font-weight:700;font-size:15px;padding:14px 28px;border-radius:40px;text-decoration:none;box-shadow:0 4px 15px rgba(0,0,0,0.2);">
                            <i class="fab fa-instagram"></i> Ver Reel en Instagram
                        ...
                        <div style="margin-top:16px;display:flex;justify-content:center;gap:24px;">
                            <div style="color:rgba(255,255,255,0.8);font-size:12px;"><i class="fas fa-play-circle"></i> Video real del proceso</div>
                            <div style="color:rgba(255,255,255,0.8);font-size:12px;"><i class="fas fa-clock"></i> ~2 minutos</div>
                        </div>
                    </div>
                </div>
            </div>
