            ...
            <div class="vehicle-card">
                ...
                <div class="vehicle-info">
                    ...
                    <div class="vehicle-actions" style="gap: 8px;">
                        ${hasKits ? `
                            <button class="button" onclick="openCustomization('${vehicle.id}')" style="flex: 1; background: linear-gradient(135deg, var(--import-red) 0%, #8b0707 100%); box-shadow: 0 4px 12px rgba(99,11,11,0.3);">
                                <i class="fas fa-magic"></i> Personalizar
                            </button>
                        ` : ''}
                        <button class="button ${hasKits ? 'button-outline' : ''}" onclick="showVehicleDetails('${vehicle.id}')" style="flex: 1;">
                            ${hasKits ? '<i class="fas fa-info-circle"></i>' : ''} Detalles
                        </button>
                        <button class="button button-outline" onclick="openConsultation('${vehicle.id}')" style="flex: 1;">
